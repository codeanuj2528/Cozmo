...
| 2b | Ceiling height, reported at all | a number or an honest abstention | **8 of 24 rooms report exactly 0.0 m** with interval `[-0.03, 0.03]` and method `prior_only` | FAIL |
...
| D4 | Walls geometrically impossible for their room | `c7d28f72c6` room_03: 7.65 m, 6.83 m and 5.93 m walls in a 4.48 m² room (limit 5.89 m) | same as D3 |
