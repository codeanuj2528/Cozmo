...
| 7 | Calibrate 0.5× and 1× separately | **Reasonable; not implemented** | EXIF `LensModel` puts all 58 original photos on the 2.22 mm ultra-wide of an iPhone 17 Pro: 54 at the 14 mm equivalent, 4 digitally cropped to 17 or 21 mm. On 13 Sep the hall was re-shot on the 1× main camera (24 mm): the 0.5× hall was rejected at 71.8 m², the 1× hall reads 35.12 m² against 14.86 m² taped. Per-lens calibration itself is not implemented. |
...
| Tests for scale, area error, graph, ceiling thresholds | Met, 68 tests. |
